...
<form action="/kas-kelas" method="GET" class="row g-2 mb-3 align-items-center">
    <div class="col-auto">
    ...
    <div class="col-auto d-flex flex-wrap gap-2">
        ...
        <div class="card shadow-sm border-0 mt-4">
            <div class="card-header bg-danger text-white fw-bold d-flex justify-content-between align-items-center">
                <span>⚠️ Belum Bayar (Bulan {{ date('M Y', strtotime($bulanAktif . '-01')) }})</span>
                <span class="badge bg-light text-danger rounded-pill">{{ count($belumBayar) }} Orang</span>
            </div>
                ...
                <ul class="list-group list-group-flush" style="max-height: 250px; overflow-y: auto;">
                    @forelse($belumBayar as $namaNunggak)
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            <span class="fw-medium">{{ $namaNunggak }}</span>
                            
                            @php
                                // Teks WA buat nagih otomatis
                                $teksTagih = "Assalamu'alaikum, halo " . $namaNunggak . ". %0A%0AIngin mengingatkan untuk pembayaran Kas Kelas bulan " . date('F Y', strtotime($bulanAktif . '-01')) . " belum tercatat nih. Yuk segera dilunaskan! 🙏";
                            @endphp
                            
                            <a href="https://wa.me/?text={{ $teksTagih }}" target="_blank" class="btn btn-sm btn-outline-success d-flex align-items-center gap-1">
                    ...
                    @empty
                        <li class="list-group-item text-center text-muted fw-bold py-4">
                            🎉 Keren! Semuanya udah lunas!
                        </li>
                    @endforelse
                </ul>
            </div>
